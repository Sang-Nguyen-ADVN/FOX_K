 ...
 */
@Deprecated(message = "The apiElements configuration has been deprecated for dependency declaration. Please use the 'implementation' or 'compileOnly' configuration instead.")
internal
