 ...
 */
@Deprecated(message = "The compileClasspath configuration has been deprecated for dependency declaration. Please use the 'implementation' or 'compileOnly' configuration instead.")
internal
