...
package gradle.kotlin.dsl.plugins._54c95c49b62a658524fa369c7c9bbe75
...
/**
 * The `com.google.firebase.crashlytics` plugin implemented by [com.google.firebase.crashlytics.buildtools.gradle.CrashlyticsPlugin].
 */
internal
val `ComGoogleFirebasePluginGroup`.`crashlytics`: PluginDependencySpec
    get() = plugins.id("com.google.firebase.crashlytics")


/**
 * The `com.google.firebase.firebase-perf` plugin implemented by [com.google.firebase.perf.plugin.FirebasePerfPlugin].
 */
internal
val `ComGoogleFirebasePluginGroup`.`firebase-perf`: PluginDependencySpec
    get() = plugins.id("com.google.firebase.firebase-perf")


/**
 * The `com.google.gms` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComGoogleGmsPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.google.gms`.
 */
internal
val `ComGooglePluginGroup`.`gms`: `ComGoogleGmsPluginGroup`
    get() = `ComGoogleGmsPluginGroup`(plugins)


/**
 * The `com.google.gms.google-services` plugin implemented by [com.google.gms.googleservices.GoogleServicesPlugin].
 */
internal
val `ComGoogleGmsPluginGroup`.`google-services`: PluginDependencySpec
    get() = plugins.id("com.google.gms.google-services")
