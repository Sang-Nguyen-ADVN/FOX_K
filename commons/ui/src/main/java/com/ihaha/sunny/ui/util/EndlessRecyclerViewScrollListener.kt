package com.ihaha.sunny.ui.util
...
abstract class EndlessRecyclerViewScrollListener(
    ...
    override fun onScrolled(view: RecyclerView, dx: Int, dy: Int) {
        ...
        // If it’s still loadingState, we check to see if the dataset count has
        // changed, if so we conclude it has finished loadingState and update the current page
        // number and total item count.

        // If it isn’t currently loadingState, we check to see if we have breached
    ...
    // Defines the process for actually loadingState more data based on page
