...
import net.ihaha.sunny.fox.databinding.FragmentWelcomeBinding
import net.ihaha.sunny.fox.domain.model.auth.User
import net.ihaha.sunny.ui.extensions.hide
import net.ihaha.sunny.ui.extensions.show
...
class WelcomeFragment : BaseBindingFragment<FragmentWelcomeBinding, WelcomeViewModel>() {
    ...
    private fun initEventListener() {
        launch {
            delay(2000)
            if(currentUser != null){
                viewBinding.tvWelcome.text = String.format("Chào mừng % đã trở lại", currentUser?.username)
